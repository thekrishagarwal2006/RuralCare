    ...
    <div className="max-w-6xl mx-auto px-4 py-8 space-y-6">
      <div className="border-b border-slate-200 pb-4">
        <h1 className="text-2xl font-bold text-slate-900 flex items-center gap-2">
          <Shield className="h-6 w-6 text-amber-500" /> Admin & Mid-Sem Evaluation Control Panel
        </h1>
        <p className="text-xs text-slate-500 mt-1">
          Facilitates evaluator demonstration testing by triggering actual database/backend resource updates and GPS simulation ticks.
        </p>
      </div>
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-3">
        <h3 className="font-bold text-slate-900 text-sm">Evaluation Test Script Instructions</h3>
